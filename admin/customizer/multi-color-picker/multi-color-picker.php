...
class Customize_Multi_Color_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_script('multi-color-picker', get_template_directory_uri() . '/admin/customizer/multi-color-picker/multi-color-picker.js', array('jquery', 'wp-color-picker'), '1.0.0', true);
        wp_enqueue_style('multi-color-picker', get_template_directory_uri() . '/admin/customizer/multi-color-picker/multi-color-picker.css', array('wp-color-picker'), '1.0.0');
    }
